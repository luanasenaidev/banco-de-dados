...
```
![Relatório 2](resultados_alunos/relatorio2.png)
...
```
![Relatório 3](resultados_alunos/relatorio3.png)
...
```
![Relatório 4](resultados_alunos/relatorio4.png)
<!-- _________________________ -->
...
```
![Relatório 5](resultados_alunos/relatorio5.png)
...
```
![Relatório 6](resultados_alunos/relatorio6.png)
...
```
![Relatório 7](resultados_alunos/relatorio7.png)
...
```
![Relatório 8](resultados_alunos/relatorio8.png)
...
```
![Relatório 9](resultados_alunos/relatorio9.png)
...
```
![Relatório 11](resultados_alunos/relatorio11.png)
...
![Relatório 12](resultados_alunos/relatorio122.jpg)
<!-- _________________________ -->
### 13) Faça uma consulta que mostre a lista de alunos atualizada e o título dos cursos que fazem, classificados pelo nome do aluno.
```sql

-- 17ª Digitação (SQL para criar a consulta acima)
SELECT alunos.nome, cursos.titulo FROM alunos JOIN cursos ON alunos.curso_id = cursos.id ORDER BY alunos.nome;
```
...
```
![Desafio 1](resultados_alunos/desafio1.png)
...
```
![Desafio 2](resultados_alunos/desafio2.png)
...
```
![Desafio 3](resultados_alunos/desafio3.png)
...
```
![Desafio 4](resultados_alunos/desafio4.png)